# ---------------------------------------------------------------------------- #
# Evaluation script for 3D point cloud matching using both 3D point cloud and image data
    ...
    for scene_root in scene_roots:
        ...
        for file_name in file_names:
            ...
            if gt_indices[ref_frame, src_frame] != -1:
                ...
                flags_per_scene.append(2)
            est_traj_per_scene.append(estimated_transform)

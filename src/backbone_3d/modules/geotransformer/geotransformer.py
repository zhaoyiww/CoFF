...
from src.backbone_3d.modules.ops import pairwise_distance
from src.backbone_3d.modules.transformer import SinusoidalPositionalEmbedding, RPEConditionalTransformer
...
class GeometricTransformer(nn.Module):
    def __init__(
        ...
        # hidden_dim 256, sigma_d 0.2, sigma_a 15, angle_k 3
